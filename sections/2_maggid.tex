...
}{It is customary to spill a drop from the cup upon saying, `blood,' and `fire,' and `pillars of smoke,' the ten plagues, ``d'tsakh," ``adash," ``b'ahav," together, fifteen times.}
...
\begin{english}
\engloss{---and portents} this is the blood, as it says, \bibverse{And I will provide portents in the heavens and the earth: blood and fire and pillars of smoke!}
\end{english}
