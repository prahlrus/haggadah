...
\begin{english}
The one who does not know what to ask, you must open up their mouth, as it says, 
\end{english}
...
\begin{english}
``\bibverse{And you will tell your child on that day, saying, this is all on account of what Hashem did for me by taking me out of Egypt}." Why could this not be any time after Rosh Hodesh Nisan? Scripture says, \bibverse{on that day}. Why could this not happen during the day? Rather, the scripture says, \bibverse{on account of [what Hashem did for me]}, that is, ``I did not say anything except at the hour when there is matso and maror set before you."
\end{english}
...
\begin{english}
\bibverse{And the Egyptions were evil to us and they oppressed us, and they gave us hard labor.} \engloss{And the Egyptians were evil to us} as it says, \bibverse{Let us concoct a scheme against this people, lest it multiply, and when war is declared it will join with our enemies to make war on us, rise up out from the land.} \engloss{And they oppressed us} as it says, \bibverse{They set over the people overseers to oppress them with burdens. And they built for Paroh store-cities: Pithom and Raamses.} \engloss{And they set over them hard labor} as it says, \bibverse{And the Egyptians enslaved the Yisroelites with crushing work.}
\end{english}
